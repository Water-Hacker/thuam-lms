...
def get_controller(payment_gateway):
    if "payments" in frappe.get_installed_apps():
        from payments.utils import get_payment_gateway_controller # type: ignore
...
def get_payment_link(
    ...
    # Return a message indicating that payments are not required
    return "Payments are not required for this document."

    # If you want to redirect to a specific URL instead, you can do so:
    # return "https://example.com/no-payment-required"
